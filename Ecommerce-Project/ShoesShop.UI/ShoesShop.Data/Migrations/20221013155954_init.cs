        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    ProductGenderCategory = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentProducts", x => new { x.ProductId, x.CustomerId });
                    table.ForeignKey(
                        name: "FK_CommentProducts_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => new { x.OrderId, x.ProductId, x.AttributeValueId });
                    table.ForeignKey(
                        name: "FK_OrderDetails_AttributeValues_AttributeValueId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentProducts_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_AttributeValueId",
                table: "OrderDetails",
